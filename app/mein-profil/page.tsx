...
import { changeAlias, changePassword, changeProfileImage, deleteAccount, requestNameChange, submitClaim } from "./actions";
...
export default async function Page() {
  ...
  return <main className="account-shell wide">
    ...
    <section><h2>Profilbild</h2><form action={changeProfileImage} className="account-form"><input name="image" type="file" accept="image/jpeg,image/png,image/webp" required /><button>Profilbild hochladen</button></form></section>
